...
TEST(TExpressionAnalyzer, double_numbers_addition) {
    TExpressionAnalyzer a("34.55 + 7.12");
    EXPECT_NEAR(a.FormulaCalculator(), 41.67, 0.0001);
}

TEST(TExpressionAnalyzer, double_numbers_subtraction) {
    TExpressionAnalyzer a("100.5 - 25.25");
    EXPECT_NEAR(a.FormulaCalculator(), 75.25, 0.0001);
}
TEST(TExpressionAnalyzer, complex_double_expression) {
    TExpressionAnalyzer a("(12.75 + 3.25) * (8.5 - 2.5) / 4.0");
    EXPECT_NEAR(a.FormulaCalculator(), 24.0, 0.0001);
}
